...
void thid(){//дефаутовое количество циклов 100000(вроде)
	for(int n=0; n<1; n++)
     {
	     int s1=45+123;
	     int s2=4561-2541;
...
int deinit()
{
	...
	//---------------------------------------------------------------------------------------------
		...
		//---------------------------------------------------------------------------------------------
				...
				int WriteFileBody=FileWrite(file,";"+CycleNumber+";"+time+";"+CalculationResult);	//Записываем строку с результатами теста
		//Запись в фаил

...
//| Strategy 1.3127 EA
//|
//|    Generated by Genetic Builder version 2.2.1
//|    Generated at Thu Mar 21 14:48:00 GMT 2013
//|                                                          
//|    Tested on EURUSD, H1, 2010.12.01 - 2013.02.28
//|    Spread: 1.5, Slippage: 0.0, Min distance of stop from price: 5
//+------------------------------------------------------------------+

#property copyright "GeneticBuilder.com"
...
extern int LongStopLoss = 57;
extern int LongProfitTarget = 59;
extern int ShortStopLoss = 57;
extern int ShortProfitTarget = 59;

extern double MinimumSLPT = 30;
extern double MaximumSLPT = 80;
...
extern string CustomComment = "Strategy 1.3127";
...
int start() {
   ...
   // LONG: ((Low(19) > Open(18)) And ((((Open(10) > High(11)) Or (Close(11) > Open(5))) Or (Close(4) > Open(12))) And (High(6) > Open(6))))

   if(TradeLong) {
      bool LongEntryCondition = ((Low[19] > Open[18]) && ((((Open[10] > High[11]) || (Close[11] > Open[5])) || (Close[4] > Open[12])) && (High[6] > Open[6])));
      if(LongEntryCondition == true) {
         openPosition(1);
      }
   }
   
   // SHORT: ((High(19) < Open(18)) And ((((Open(10) < Low(11)) Or (Close(11) < Open(5))) Or (Close(4) < Open(12))) And (Low(6) < Open(6))))

   if(TradeShort) {
      bool ShortEntryCondition = ((High[19] < Open[18]) && ((((Open[10] < Low[11]) || (Close[11] < Open[5])) || (Close[4] < Open[12])) && (Low[6] < Open[6])));
